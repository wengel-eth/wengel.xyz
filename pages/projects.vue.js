const Projects = Vue.component('projects', {
	template: `
		<container class="page-body">
			<section class="title-slide bottom left" style="background-image:linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.5)),url('https://ik.imagekit.io/wengel/wengel_xyz/IMG_9655_z_yUF3J6VC3.jpg?tr=w-1440,pr-true')">
				<h1>Projects.</h1>
			</section>
			<content-b color="dark-blue"
				image="background-image:url('https://ik.imagekit.io/wengel/wengel_xyz/engelheim_website_TYgHCU5MitL.jpg?tr=w-1080,h-1080,fo-center,pr-true');"
				heading="wengel.xyz"
			...
			></content-b>
			<content-b color="dark-blue"
				image="background-image:url('https://ik.imagekit.io/wengel/wengel_xyz/Perspective-Web-Mockup-17-Main_File_3Fb72KHy1.png?tr=w-1080,h-1080,fo-center,pr-true');"
				heading="molllo.com"
