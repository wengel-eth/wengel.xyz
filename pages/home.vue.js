	...
	template: `
		<container class="page-body">
			<section class="title-slide home top left"
				style="background-image:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.2)),url('https://ik.imagekit.io/wengel/wengel_xyz/IMG_7325_lm1xxNeU8c6t.jpg?tr=w-1080,pr-true');">
				<h1>William Engel.</h1>
			</section>
			...
			></content-a>
			<content-a color="dark-blue"
				image="https://ik.imagekit.io/wengel/wengel_xyz/IMG_0250_ATRfb6sMQcXB.jpg?tr=w-1080,pr-true"
				link="/"
