	...
	template: `
		<container class="page-body">
			...
			<content-a color="dark-blue"
				...
				p="I love to design video/board games and hope to publish one one day. I have designed many board games in my free time but never really published one. If I ever get around to it, the page will be through this link."
			></content-a>
		</container>
	`
});
